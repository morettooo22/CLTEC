...
<body>
    ...
    <div class="container">
    <div class="login">
        <a href="home.php"><img class="voltar" src="../image/voltar.png" alt="voltar"></a>
        <h1>Bem-vindo a Página de Login!</h1><br>
        <h2>Entre com seus dados abaixo para continuar:</h2>
        <form action="testeLogin.php" method="post">
